            ...
            <div className="animated slideInUpTiny animation-duration-3">
                <div className="app-wrapper">
                    ...
                    <div className="shadow border-0 card">
                        ...
                        <div>
                            <Nav tabs>
                                    <NavItem>
                                        ...
                                        <NavLink>
                                         <Link  to={`./Coor_proposalUI`} className="normal" activeClassName="active" style={{color:'black'}}><b>ข้อมูลทั่วไป</b></Link>   
                                        </NavLink>
                                    </NavItem>
                                    <NavItem>
                                        <NavLink>
                                         <Link  to={`./Coor_proposalUI1`} className="normal" style={{color:'black'}}><b>รายละเอียดโครงการ</b></Link>   
                                        </NavLink>
                                    </NavItem>
                                    <NavItem>
                                        <NavLink>
                                         <Link to={`./Coor_proposalUI2`} className="link" style={{color:'black'}}><b>คณะผู้วิจัย</b></Link>   
                                        </NavLink>
                                    </NavItem>
                                    <NavItem>
                                        <NavLink>
                        ...
                        <div className="card">
                            <div style={{ paddingLeft: 30, marginTop: 40 }}><span style={{ color: 'red' }}>*</span>&nbsp;<b style={{ color: 'blue' }}>ความสำคัญและที่มาของปัญหาที่ทำการวิจัย<hr></hr></b></div>
                            ...
                            <div style={{ paddingLeft: 50, marginTop: 40 }}><span style={{ color: 'red' }}>*</span>&nbsp;<b style={{ color: 'blue' }}>การทบทวนวรรณกรรม/สารสนเทศ (information) ที่เกี่ยวข้อง<hr></hr></b></div>
                            <div className="form-group">
                                <div className="col-lg-1">
                                </div>
                                <div className="col-lg-12" style={{ marginLeft: 10 }}>
                            ...
                            <div style={{ paddingLeft: 50, marginTop: 40 }}><span style={{ color: 'red' }}>*</span>&nbsp;<b style={{ color: 'blue' }}>ทฤษฎี สมมติฐาน และ/หรือกรอบแนวความคิดของการวิจัย<hr></hr></b></div>
                            <div className="form-group">
                                <div className="col-lg-1">
                                </div>
                                <div className="col-lg-12" style={{ marginLeft: 10 }}>
                            ...
                            <div style={{ paddingLeft: 50, marginTop: 40 }}><span style={{ color: 'red' }}>*</span>&nbsp;<b style={{ color: 'blue' }}>เอกสารอ้างอิง<hr></hr></b></div>
                            <div className="form-group">
                                <div className="col-lg-1">
                                </div>
                                <div className="col-lg-12" style={{ marginLeft: 10 }}>
